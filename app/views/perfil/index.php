...
<img id="img_preview"
     ...
     style="object-fit:cover; border:3px solid var(--lim-blue);">
                ...
                if (empty($rolesLista) && !empty($user['rol'])) {
                    ...
                    $r = trim($r);
                ?>
                <span class="badge bg-primary" style="font-size:10px;"><?= e($r) ?></span>
                <?php endforeach;
                } else {
                    foreach ($rolesLista as $rol):
                ?>
                <span class="badge bg-primary" style="font-size:10px;"><?= e($rol['rol']) ?></span>
                <?php endforeach; } ?>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <dl class="row">
                    ...
                    ?>
                    <span class="badge bg-primary" style="font-size:10px;"><?= e($rr) ?></span>
                    <?php endforeach;
                    } else { foreach ($rolesInfo as $rItem): ?>
                    <span class="badge bg-primary" style="font-size:10px;"><?= e($rItem['rol']) ?></span>
                    <?php endforeach; } ?>
                    </div>
                </dd>
