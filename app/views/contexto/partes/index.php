        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center gap-3 py-3">
                ...
                <div>
                    ...
                    <div style="font-size:11px;color:#6b7280;">Partes Internas</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center gap-3 py-3">
                ...
                <div>
                    ...
                    <div style="font-size:11px;color:#6b7280;">Partes Externas</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm" style="background:var(--lim-blue);">
            <div class="card-body d-flex align-items-center gap-3 py-3">
                ...
                <div>
                    ...
                    <div style="font-size:11px;color:rgba(255,255,255,.7);">Total</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body p-0">
        <table class="table table-hover table-sm datatable datatable-export mb-0" style="width:100%;">
            ...
            <tr>
                ...
                <td class="text-center">
                    <span class="badge <?= $nivelBadge($p['nivel_interes']) ?>" style="font-size:10px;">
                        <?= $p['nivel_interes'] ?>
                    </span>
                </td>
                <td class="text-center">
