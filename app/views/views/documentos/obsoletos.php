    ...
    <div class="card-body p-0">
        <table id="tbl-obsoletos" class="table table-hover table-sm mb-0" style="width:100%;">
            ...
            <tr>
                ...
                <td><span style="font-size:12px;background:#f1f5f9;padding:2px 5px;border-radius:3px;"><?= e($d['codigo'] ?? '') ?></span></td>
                <td style="font-size:12px;"><?= e($d['nombre_documento'] ?? '') ?></td>
                <td><span class="badge bg-secondary" style="font-size:12px;line-height:1.4;"><?= e($d['sigla_tipo_documento'] ?? '') ?><br><small style='font-size:12px;font-weight:normal;opacity:.85;'><?= e($d['tipo_documento'] ?? '') ?></small></span></td>
                <td class="text-center"><span class="badge bg-dark">V<?= e($d['numero_version'] ?? 0) ?></span></td>
                <td style="font-size:12px;"><?= e(truncar($d['elaborador'] ?? $d['usuario_creacion'] ?? '—', 25)) ?></td>
                <td style="font-size:12px;"><?= e(truncar($d['revisor'] ?? $d['usuario_revision'] ?? '—', 25)) ?></td>
                <td style="font-size:12px;"><?= e(truncar($d['aprobador'] ?? $d['usuario_aprobacion'] ?? '—', 25)) ?></td>
