...
$grupos = [
    ...
    ['icono'=>'bi-award','titulo'=>'SGC — Calidad','color'=>'success','reportes'=>[
        ...
        ['/reportes/sgc/contexto',            'bi-diagram-3',     'Contexto Organizacional §4.1',  'Análisis FODA y partes interesadas del sistema de gestión.'],
    ]],
    ['icono'=>'bi-shield-lock','titulo'=>'Seguridad','color'=>'secondary','reportes'=>[
        ['/reportes/seguridad/usuarios',    'bi-people',    'Estado de Usuarios',           'Nombre, estado, fecha activación, vencimiento y último acceso por usuario.'],
        ['/reportes/seguridad/contrasenas',  'bi-shield-lock', 'Historial de Contraseñas',   'Historial de cambios de contraseña por usuario con fechas.'],
