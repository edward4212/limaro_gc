        ...
        <table class="table table-hover table-sm datatable datatable-export mb-0"
            ...
            <tr>
                <td>
                    ...
                    <br><span class="text-muted" style="font-size:12px;">Sol.<?= (int)$t['id_solicitud'] ?></span>
                </td>
                <td style="font-size:12px;max-width:180px;">
                    <?= e($t['tipo_documento'] ?? '—') ?>
                </td>
                <td style="font-size:12px;"><?= labelTipoSolicitud($t['tipo_solicitud'] ?? '') ?></td>
                <td>
                    <span class="badge <?= $prio[0] ?>" style="font-size:12px;"><?= $prio[1] ?></span>
                </td>
                <td style="font-size:12px;min-width:160px;word-break:break-word;">
                ...
                <td class="text-center">
                    <span class="badge <?= $badgeCls ?>" style="font-size:12px;">
