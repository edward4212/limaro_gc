        ...
        <form action="<?= e(APP_URL) ?>/tareas/revisar/<?= e($tarea['id_tarea']) ?>"
            ...
            <div class="mb-3">
                <label class="form-label">
                    ...
                    <span class="text-muted" style="font-size:12px;">(requerido para enviar a aprobación)</span>
                </label>
            ...
            <div class="d-flex gap-2">
                ...
                <button type="submit" name="accion" value="rechazar"
                    ...
                    <span class="badge bg-light text-dark ms-1 fw-normal" style="font-size:12px;">
                        <?= e($tarea['elaborador']) ?>
                    </span>
                    <?php endif; ?>
                </button>
