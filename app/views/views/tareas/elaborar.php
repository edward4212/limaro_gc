...
<div class="card mt-3 border-info">
    <div class="card-header bg-info bg-opacity-10">
        ...
        <span class="badge bg-info ms-2" style="font-size:12px;">Versión 0 — BORRADOR</span>
    </div>
    <div class="card-body">
    ...
    <div class="card-body">
            ...
            <div class="mb-3">
                <label class="form-label">
                    ...
                    <span class="text-muted" style="font-size:12px;">(requerido para enviar a revisión)</span>
                </label>
