        ...
        <table class="table table-hover datatable mb-0" style="width:100%;">
            ...
            <tr class="<?= $estado === 'DEVUELTO' ? 'table-danger' : '' ?>">
                <td>
                    ...
                    <br><small class="text-muted" style="font-size:12px;">Sol.<?= (int)$t['id_solicitud'] ?></small>
                </td>
                ...
                <td>
                    <span class="badge <?= $prioridad[0] ?>" style="font-size:12px;">
                        <?= $prioridad[1] ?>
                    </span>
                </td>
                <td>
                    ...
                    <span class="badge bg-secondary" style="font-size:12px;">inactiva</span>
                    <?php endif; ?>
                </td>
                <td class="text-center">
                    <span class="badge <?= $badge ?> d-flex align-items-center justify-content-center gap-1" style="font-size:12px;">
                        <i class="bi <?= $icono ?>"></i>
                        <?= $estado ?>
                    </span>
                </td>
