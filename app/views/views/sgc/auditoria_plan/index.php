    ...
    <div class="card-body p-0">
        ...
        <table class="table table-hover table-sm datatable datatable-export mb-0">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><code style="font-size:12px;"><?= e($p['codigo']) ?></code></td>
                    ...
                    <td style="font-size:12px;max-width:150px;"><?= e($p['procesos'] ?? '—') ?></td>
                    <td class="text-center" style="min-width:90px;">
                        ...
                        <small class="text-muted" style="font-size:12px;"><?= $comp ?>/<?= $tot ?></small>
                        <?php else: ?>
                        <small class="text-muted" style="font-size:12px;">Sin actividades</small>
                        <?php endif; ?>
                    </td>
