        ...
        <table class="table table-hover table-sm datatable datatable-export mb-0"
            ...
            <tr class="<?= $vencido ? 'table-danger' : '' ?>">
                ...
                <td style="font-size:12px;max-width:220px;">
                    ...
                    <br><span class="badge bg-primary" style="font-size:12px;">AC vinculada</span>
                    <?php endif; ?>
                </td>
                <td>
                ...
                <td style="font-size:12px;"><?= e(truncar($h['programa_descripcion'] ?? '—', 35)) ?></td>
                <td style="font-size:12px;"><?= e($h['responsable_ac'] ?? '—') ?></td>
                <td class="text-center">
                    <span class="badge <?= $badge ?>" style="font-size:12px;">
                        <?= str_replace('_',' ', $h['estado'] ?? '—') ?>
                    </span>
                    <?php if ($vencido): ?>
                    <br><span class="badge bg-danger" style="font-size:12px;">VENCIDO</span>
                    <?php endif; ?>
                </td>
                <td style="font-size:12px;<?= $vencido ? 'color:#dc2626;font-weight:600;' : '' ?>">
