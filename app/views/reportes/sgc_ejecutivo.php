    ...
    <div class="table-responsive">
        <table class="table table-sm mb-0">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><code style="font-size:11px;"><?= e($o['codigo']) ?></code></td>
                    <td style="font-size:12px;"><?= e(truncar($o['objetivo'],45)) ?></td>
                    <td><span class="badge bg-primary" style="font-size:10px;"><?= e($o['meta']??'—') ?></span></td>
                    <td>
                        <?php if ($pct !== null): ?>
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <small class="text-<?= $color ?> fw-bold" style="font-size:11px;"><?= $pct ?>%</small>
                        </div>
                        <?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-sm mb-0">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><span class="badge bg-<?= $ct ?>" style="font-size:9px;"><?= str_replace('_',' ',$h['tipo']) ?></span></td>
                    <td><code style="font-size:10px;"><?= e($h['clausula_iso']??'—') ?></code></td>
                    <td style="font-size:11px;"><?= e(truncar($h['descripcion'],50)) ?></td>
...
<div class="mt-3 text-muted text-center no-print" style="font-size:11px;">
