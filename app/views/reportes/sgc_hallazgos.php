<?php
$campos = ['anio'];
$opciones = ['anio'=>true,'estados'=>['ABIERTO','EN_TRATAMIENTO','CERRADO'],'tipos'=>['NO_CONFORMIDAD','OBSERVACION','OPORTUNIDAD','FORTALEZA']];
?>
...
<tr>
<td><?= e($d['anio']) ?></td>
<td style="font-size:11px;"><?= e(truncar($d['programa'],40)) ?></td>
<td><span class="badge bg-<?= $colorT ?>" style="font-size:10px;"><?= str_replace('_',' ',$d['tipo']) ?></span></td>
<td><code style="font-size:11px;"><?= e($d['clausula_iso'] ?? '—') ?></code></td>
<td style="font-size:11px;"><?= e($d['proceso_auditado'] ?? '—') ?></td>
<td style="font-size:12px;"><?= e(truncar($d['descripcion'],70)) ?></td>
<td style="font-size:11px;"><?= e($d['responsable'] ?? '—') ?></td>
<td style="font-size:11px;"><?= $d['fecha_cierre'] ? fechaEs($d['fecha_cierre']) : '—' ?></td>
