        ...
        <table class="table table-sm datatable datatable-export mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:11px;"><?= e(truncar($d['descripcion_version']??'',50)) ?></td>
                    <td style="font-size:11px;"><?= e($d['usuario_creacion']??'—') ?></td>
                    <td style="font-size:11px;"><?= e($d['usuario_revision']??'—') ?></td>
                    <td style="font-size:11px;"><?= e($d['usuario_aprobacion']??'—') ?></td>
                    <td style="font-size:11px;"><?= fechaEs($d['fecha_aprobacion']) ?></td>
                    <td style="font-size:11px;"><?= $d['fecha_obsoleto'] ? fechaEs($d['fecha_obsoleto']) : '—' ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
