<?php
$campos = ['desde','hasta'];
$opciones = ['estados'=>['CREADA','ASIGNADA','EN DESARROLLO','FINALIZADA'],'tipos'=>['CREACION','ACTUALIZACION','ELIMINACION']];
?>
...
<div style="font-size:11px;"><?= e($r['estado']) ?> / <?= e($r['tipo']) ?></div>
<div class="text-muted" style="font-size:10px;">~<?= round($r['promedio_horas'],1) ?>h prom.</div>
</div></div>
<?php endforeach; ?>
</div>
<?php endif; ?>
...
<td style="font-size:11px;"><?= e($d['prioridad']) ?></td>
<td><?= badgeEstado($d['estado_solicitud']) ?></td>
<td style="font-size:12px;"><?= e($d['funcionario_asignado'] ?? '—') ?></td>
<td style="font-size:11px;"><?= fechaEs($d['fecha_solicitud']) ?></td>
<td style="font-size:11px;"><?= $d['fecha_solucion'] ? fechaEs($d['fecha_solucion']) : '—' ?></td>
<td class="text-center" style="font-size:11px;"><?= (int)$d['horas_transcurridas'] ?>h</td>
</tr>
<?php endforeach; ?>
</tbody></table></div></div>
