        ...
        <table class="table table-hover table-sm datatable datatable-export mb-0"
            ...
            <tr>
                ...
                <td style="max-width:200px;">
                    ...
                    <?php endif; ?>
                    <small style="font-size:11px;display:block;white-space:nowrap;overflow:hidden;
                ...
                <td style="font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:130px;">
                    <?= e($s['solicitante'] ?? '—') ?>
                </td>
                <td style="font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:130px;">
